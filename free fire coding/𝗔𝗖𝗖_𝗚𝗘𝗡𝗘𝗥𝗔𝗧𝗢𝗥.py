...
# --- CONFIGURATION ---
TOKEN = '8283329429:-DtVw'
ADMIN_ID = 8406660209 
API_URL = "https://jcd-guest.vercel.app/gen"
CHANNELS = ["@JCDMODAPI", "@JCDMODS", "@JCDLIKE"]
...
def get_join_markup():
    keyboard = [
        [InlineKeyboardButton("📢 Join Channel 1", url="https://t.me/JCDMODAPI")],
        [InlineKeyboardButton("📢 Join Channel 2", url="https://t.me/JCDMODS")],
...
async def admin_redeem(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        kb = InlineKeyboardMarkup([
            [InlineKeyboardButton("📢 KAMOD OFFICIAL", url="https://t.me/JCDMODAPI")],
