...
GUEST_UID = "AHHHHHH"  # <-- EDIT THIS
GUEST_PASSWORD = "HOLY SHIT"  # <-- EDIT THIS

# Option 2: Use Access Token Directly (Needs OpenID too)
ACCESS_TOKEN = "ACCESS TOKEN"  # <-- Leave empty to use Guest Login
OPEN_ID = "OPEN ID"       # <-- Required if using ACCESS_TOKEN
...
CLIENT_SECRET = "RIZERONTOP715b7d1e3"
CLIENT_ID = "100067"
...
class Protocol:
    ...
    def build_major_login(open_id, access_token):
        ...
        fields = {
            ...
            5: 1,
            7: "2.112.2",
            8: "RIZER OS 2828282828 / OH MY GOOD",
            9: "MUTTHI MARO",
            10: "G A Y YOU A R E G A Y B O T K A H I K A S A L A",
            11: "WIFI",
            12: 37373737377373737474747474737373388,
            13: 3738833838838949949494949948383838372727277272727272727,
            14: "83838383883838383838383838383838838383833883838383383838383880",
            15: "HELLO BABY",
            16: 37737373737373737373737737,
            17: "JOHNY SINS",
            18: "JOHNY SINS",
            19: random_device,
            20: random_ip,
            ...
            42: "WIFI",
            57: "fuck you",
            60: 7778990000000900000,
            61: 277272727272829292919191919,
            62: 4747383939399393939393939,
            63: 77888888889999,
            64: 777777777,
            65: 8889999000000000,
            66: 77766666555544322334555,
            67: 7777777777777777777777777,
            73: 3,
            74: "RIZER ON TOP",
            76: 1,
            77: "9999999999999-",
            ...
            91: "REDMAGIC",
            92: " fauk you madarchud tor make chudi shala",
            95: 9999999999999,
            97: 1,
            98: 0,
            99: "8",
...
class CompleteBot:
    ...
    def print_banner(self):
        print("=" * 70)
        print("R I Z E R x ACCESS TO BAN")
        print("=" * 70)
    ...
    async def run(self):
        ...
        async with FreeFireClient() as client:
            ...
            if online_ok and chat_ok:
                print("✅ BANNED DONE RIZERx ACCESS TO BAN")
